...
class WavFile {
    ...
    private void readFromFilePath_ReadChunks_Format(DataInputStreamLittleEndian reader)
        ...
        SamplingInfo samplingInfo = new SamplingInfo("[from file]", chunkSizeInBytes, formatCode, numberOfChannels,
    ...
    private void writeToFilePath_WriteChunks(DataOutputStreamLittleEndian writer)
            throws IOException {
        int numberOfBytesInSamples = (int) (this.samplesForChannels[0].length * this.samplingInfo.numberOfChannels
    ...
    private void writeToFilePath_WriteChunks_Format(DataOutputStreamLittleEndian writer)
        ...
        writer.writeShort((short) (this.samplingInfo.numberOfChannels * this.samplingInfo.bitsPerSample / WavFile.BitsPerByte));
    ...
    public static class Sample24 extends Sample {
        ...
        public Sample buildFromBytes(byte[] valueAsBytes) {
            short valueAsShort = (short) (((valueAsBytes[0] & 0xFF)) | ((valueAsBytes[1] & 0xFF) << 8)
    ...
    public static class Sample32 extends Sample {
        ...
        public byte[] convertToBytes() {
            return new byte[]{(byte) ((this.value) & 0xFF), (byte) ((this.value >>> 8) & 0xFF),
                    (byte) ((this.value >>> 16) & 0xFF), (byte) ((this.value >>> 24) & 0xFF)};
        }
    ...
    public static class SamplingInfo {
        ...
        public SamplingInfo(String name, int chunkSizeInBytes, short formatCode, short numberOfChannels,
                            int samplesPerSecond, short bitsPerSample) {
            this.name = name;
        ...
        public static class Instances {
            public static SamplingInfo Default = new SamplingInfo("Default", 16, (short) 1, (short) 1,
                    44100, (short) 16);
        }

        public int bytesPerSecond() {
            return this.samplesPerSecond * this.numberOfChannels * this.bitsPerSample / WavFile.BitsPerByte;
        }
        ...
        public String toString() {
            String returnValue = "<SamplingInfo " + "chunkSizeInBytes='" + this.chunkSizeInBytes + "' "
                    + "formatCode='" + this.formatCode + "' " + "numberOfChannels='" + this.numberOfChannels + "' "
                    + "samplesPerSecond='" + this.samplesPerSecond + "' " + "bitsPerSample='" + this.bitsPerSample + "' " + "/>";
